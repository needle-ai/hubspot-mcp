...
async function createHubspotMcpServer(apiKey) {
  ...
  // --- Template Tools ---
  mcpServer.tool("cms_list_templates",
  ...
  mcpServer.tool("cms_get_template",
  ...
  mcpServer.tool("cms_get_template_buffer",
    "Get the current contents of the auto-save buffer for a template",
    {
  ...
  mcpServer.tool("cms_has_buffered_changes",
    "Check if the auto-save buffer differs from the live template",
    {
      template_id: z.string().describe("The unique ID of the template")
    },
    async (params) => {
  ...
  mcpServer.tool("cms_list_template_versions",
    "List all previous versions of a template",
    {
      template_id: z.string().describe("The unique ID of the template")
    },
    async (params) => {
  ...
  mcpServer.tool("cms_get_template_version",
  ...
  mcpServer.tool("cms_create_template",
    "Create a new coded template in Design Manager",
    {
  ...
  mcpServer.tool("cms_push_buffer_live",
  ...
  mcpServer.tool("cms_restore_deleted_template",
  ...
  mcpServer.tool("cms_restore_template_version",
  ...
  mcpServer.tool("cms_update_template",
    "Update a template (only included fields will be updated)",
    {
      template_id: z.string().describe("The unique ID of the template"),
  ...
  mcpServer.tool("cms_update_template_buffer",
    "Update the auto-save buffer (won't impact live object)",
    {
      template_id: z.string().describe("The unique ID of the template"),
  ...
  mcpServer.tool("cms_delete_template",
    "Mark a template as deleted (can be restored later)",
    {
